...
| [0015](ADR-0015-the-co-op.md) | The Co-op | *Proposed* — cross-operator memory; cloud, event (join-key), and mcp (Qdrant + Redis via MCP) modes; htb-api sibling MCP server upcoming |
